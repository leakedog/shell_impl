...
//         command->redirs = start_redirs(redir);
//     } else {
//         command->redirs = append_to_redirs(command->redirs, redir);
//     }
...
//                 cur_command->args = start_args(arg);
//             } else {
//                 cur_command->args = append_to_args(cur_command->args, arg);
//             }
//             it = end_it;
//         }
//     }
